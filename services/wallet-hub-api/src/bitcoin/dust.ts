/**
 * Per-output-script dust threshold (server-side mirror of the wallet's
 * apps/chrome-wallet/src/utils/btc-dust.ts).
 *
 * Bitcoin Core enforces a relay-policy "dust" limit on outputs:
 * outputs below it are non-standard and won't propagate. The number
 * depends on the output script TYPE, NOT a flat 546 sats:
 *
 ...
 * default `-dustrelayfee=3000` (3 sat/vB).
 *
